    ...
    <div className="hero min-h-screen flex items-center max-w-6xl m-auto px-4 sm:px-6 lg:px-8" >
      <div className="hero-content">
        <div className="max-w-6xl -translate-y-12">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold text-black/90">Vay Dominika</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="ghost" className="w-full sm:w-auto text-base sm:text-xl p-4 sm:p-6 rounded-[0.40rem]">Build together</Button>
          </div>
        </div>
      </div>
    </div>
