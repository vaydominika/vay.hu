...
const AboutMe = () => {
  ...
  return (
    <>
      <h2 className='text-3xl sm:text-4xl font-extrabold mb-4 text-center text-[#584d42]'>Get to know <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#584d42] to-[#978779] italic">Me</span></h2>
          ...
          <p className="text-[#584d42] p-4 sm:p-6 text-center font-semibold text-xl sm:text-2xl">🌟 Hi there! I'm Dominika 🌟</p>
            <div className="flex flex-col md:flex-row">
              <div className="md:flex-1 md:mr-6">
                <p className="text-[#978779] p-4 sm:p-6 text-left tracking-tight text-lg sm:text-2xl">
                ...
                <p className="text-[#978779] p-4 sm:p-6 text-left text-lg sm:text-2xl tracking-tight">If you're as excited about tech and creativity as I am, let's connect and create something amazing together!</p>
                ...
                <div className="flex flex-row justify-center mt-6 space-x-4">
                  ...
                  <Link href="#myworks" onClick={scrollToMyWorks}>
                    <Button variant="ghost" className="text-lg p-4 rounded-[0.40rem] text-[#978779] hover:text-[#584d42] hover:bg-[#584d421c]">View Projects</Button>
                  </Link>
                </div>
              </div>
              <div className="md:block w-full md:w-[25rem] h-[20rem] md:h-[35.7rem] flex md:mr-6 flex-col items-center justify-center md:items-end mb-4 md:mb-0 mt-6 md:mt-0">
