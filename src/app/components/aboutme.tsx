...
const AboutMe = () => {
  ...
  return (
    <>
      <h2 className='text-3xl sm:text-4xl font-extrabold mb-4 text-center'>Get to know <span className="bg-clip-text text-transparent bg-gradient-to-r from-[rgb(255,82,137)] to-[rgba(255,108,155,0.76)] italic">Me</span></h2>
      <div className="w-full max-w-5xl mx-auto mt-8 movingborder px-4 sm:px-6 lg:px-8">
        <Card className='border-none shadow-none bg-neutral-50 rounded-[0.40rem]'>
          ...
          <p className="text-gray-700 p-4 sm:p-6 text-center font-semibold text-xl sm:text-2xl">🌟 Hi there! I'm Dominika 🌟</p>
            <div className="flex flex-col md:flex-row">
              <div className="md:flex-1 md:mr-6">
                <p className="text-gray-700 p-4 sm:p-6 text-left tracking-tight text-lg sm:text-2xl">
                ...
                <p className="text-gray-700 p-4 sm:p-6 text-left text-lg sm:text-2xl tracking-tight">If you're as excited about tech and creativity as I am, let's connect and create something amazing together!</p>
              ...
              <div className="hidden md:block w-full md:w-[25rem] h-[20rem] md:h-[35.7rem] flex md:mr-6 flex-col items-center justify-center md:items-end mb-4 md:mb-0 mt-6 md:mt-0">
